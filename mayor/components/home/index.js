...
function reportView(items){
    ...
    '# for (var i=' + Number(items) + '; i < data.length +' + Number(items)  + '; i++) { #' 
        ...
        +	  '<img class="item-img" src="#=data[i-' + Number(items) + '].Images[0].Url#">'
        ...
        +	    	'<img src="images/icon-person.png" class="icon-follower">' 
        +           '#= getFollowers(data[i-' + Number(items) + ']) #' 
        +	     '</div>'
        +     '</div>' 
        +     '<div class="ad-category-info">'
        +         '<span class="address"><span class="km-icon km-icon-pinmap"></span>'
    	+ s
        +         '</span>' 
        +         '<div class="category"><a class="km-widget km-button km-state-active">' 
        +             '<span class="km-text km-icon km-icon-#=data[i-' + Number(items) + '].Category.IconName #"></span>' 
        +             '<!--span class="km-text km-icon km-icon-#=data[i-' + Number(items) + '].Category.Class #">&num;#=data[i-' + Number(items) + '].Category.Name #</span-->' 
        +         '</a></div>' 
        +     '</div>' 
        + '</div>' 
    + '# } #'
